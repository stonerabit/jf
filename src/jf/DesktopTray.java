...
import static jf.KB.showDesktop;
import static jf.Print.printsln;

public class DesktopTray implements java.awt.event.ActionListener{
java.awt.PopupMenu popup;
java.awt.MenuItem open, close;
java.awt.TrayIcon trayicon;/*javax.swing.JFrame jframe;*/
String classname="";
String methodname="";
String iconFilePath="image/desktop2.jpg";

public DesktopTray(){/*this.jframe=jframe; 初始化托盘组件*/
	init();
}

public DesktopTray(String iconFilePath){
	this.iconFilePath=iconFilePath;
	init();
}

public DesktopTray(String classname,String methodname){
...
public DesktopTray(String classname,String methodname,String iconFilePath){
	this.classname=classname;
...
public DesktopTray(javax.swing.JFrame jframe){/*	this.jframe=jframe; 初始化托盘组件*/
	init();
}/*初始化程序托盘组件*/
